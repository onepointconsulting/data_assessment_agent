...
def create_topic_scores_2() -> TopicScoreResult:
    session_id = "b8ce68f0-f754-4af8-8822-97dac817250d"
    topic_scores = [
        TopicScore(topic_name="Advanced Analytics", max_score=50, score=10),
        TopicScore(topic_name="Business Alignment", max_score=50, score=10),
        TopicScore(topic_name="Data Acquisition", max_score=50, score=0),
    ]
    return TopicScoreResult(session_id=session_id, topic_scores=topic_scores)
