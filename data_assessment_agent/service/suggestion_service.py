...
from data_assessment_agent.model.assessment_framework import SuggestedResponseList, suggested_response_list_spec
...
async def get_suggestion(question: str) -> Union[SuggestedResponseList, None]:
...
async def extract_suggested_responses(chat_completion: ChatCompletion) -> Union[SuggestedResponseList, None]:
...
if __name__ == "__main__":
    ...
    res = asyncio.run(get_suggestion(question))
